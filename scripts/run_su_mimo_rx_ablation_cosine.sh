...
output_root="${OUTPUT_ROOT:-runs/su_mimo_tdl_mix_rx_ablation_warmup_cosine_tail${constant_tail_epochs}_seed${seed}}"
...
run_one rx16_phase_invariant su_mimo_phase_invariant 16
run_one rx2_phase_invariant su_mimo_phase_invariant 2
run_one rx16_phase_sensitive su_mimo_phase_sensitive 16
run_one rx2_phase_sensitive su_mimo_phase_sensitive 2

echo "Completed four-run SU-MIMO Rx/readout ablation under $output_root"
